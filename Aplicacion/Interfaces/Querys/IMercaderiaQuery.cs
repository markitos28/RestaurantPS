...
namespace Aplicacion.Interfaces.Querys
{
    public interface IMercaderiaQuery
    {
        ...
        public Mercaderia SelectMercaderia(string nombre); // Retorna la primer mercaderia que encuentre con el nombre exacto de parametro
        ...
        public Mercaderia SelectMercaderia(int mercaderiaId); // Retorna uan mercaderia con el ID exacto pasado por parametros
